...
class Exp(MyExp):
    def __init__(self):
        ...
        self.train_ann = "metadata/v8/v3.0onwards_8_cls_70_30split_06_27_15_05/extended_train_annotations_coco_fmt.json"
        ...
        self.train_name = ''
        self.val_name = ''
        self.wandb_name = f"yolox_nano_v8extended_train_8cls_1080x1920_v3_0onwards_06_27_15_05_{date.today()}"
