...
class Exp(MyExp):
    def __init__(self):
        ...
        self.output_dir = f"/shared/users/raajitha/YOLOVexperiments/yolov++_base_x_s_3840x2160_stride{self.seq_stride}_gframe{self.gframe}_8cls_trimmed100_fixedlen_02_27_split_vid_20ep_{date.today()}"
